...
class ComicScraper(GeneralScraper):
    ...
    async def comic_random(self, ctx):
        ...
        random_methods = self.get_all_subcommands(ComicScraper.comic, "random")
    ...
    async def comic_latest(self, ctx):
        ...
        latest_methods = self.get_all_subcommands(ComicScraper.comic, "latest")
    ...
    def get_all_subcommands(self, group, must_contain=None,):
